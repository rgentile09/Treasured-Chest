        ...
        <div className="wrapper">
            ...
            <div className="section form">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <textarea id="description" placeholder="Enter a description for the Memory" value={description} onChange={handleDescriptionChange} required style={{ display: 'block', marginBottom: '10px', width: '100%', height: '100px' }} placeholder="Description"/>
